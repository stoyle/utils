...
/**
 * Constructs an pathname beginning with "/" and ending without
 *
 * @param {String} args Pathnames to combine.
 *
...
const pathnameBuilder = (...args) => {
    ...
    return `/${[].concat.apply([], parts).join('/')}`; // eslint-disable-line prefer-spread
};
